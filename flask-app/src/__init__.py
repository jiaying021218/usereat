...
def create_app():
    ...
    app.config['MYSQL_DATABASE_DB'] = 'usereat'  # Change this to your DB name
    ...
    from src.employee_jacob_blueprint.employee_jacob_blueprint import employee_jacob_blueprint
